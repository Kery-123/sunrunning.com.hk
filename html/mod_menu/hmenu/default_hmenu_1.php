...
$menu_html = buildMenu($list, $default_id, $active_id, $path, array(
		...
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-99bb-19',
...
$resp_menu = buildMenu($list, $default_id, $active_id, $path, array(
        ...
        'link_style' => 'padding: 10px 20px;',
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-99bb-20',
		'submenu_item_class' => 'u-nav-item',
